    ...
    return (
        <div className="max-w-2xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
                <Link href="/incomes" className="p-2 hover:bg-white/10 rounded-full transition-colors">
                    <FaArrowLeft />
                </Link>
                <h1 className="text-3xl font-bold">Yeni Gelir Ekle</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white dark:bg-white/5 backdrop-blur-xl p-8 rounded-2xl space-y-6 shadow-2xl shadow-[#71717114] dark:shadow-white/5 border border-gray-200 dark:border-white/10">
                ...
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 p-4 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-100 dark:bg-white/5">
